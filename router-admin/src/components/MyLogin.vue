    ...
    <div class="login-box">
      ...
      <div class="form-login p-4">
        ...
        <div class="form-group form-inline">
          ...
          <input type="text" class="form-control ml-2" id="username" placeholder="请输入登录名称" autocomplete="off" v-model="account">
        </div>
        <!-- 登录密码 -->
        <div class="form-group form-inline">
  ...
  methods: {
    ...
    login() {
      if (this.account === 'admin' && this.password === '123456') {
        //登录成功
        localStorage.setItem('token','ajsdlfjlsdjflsdjlfjsdlfj')
